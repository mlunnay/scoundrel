...
import { TweenToPositionData } from "./tweentocurrentposition";
 ...
 */
export class TweenToZone extends ActionBase implements Initializer {
    /**
    ...
    public initialize(_emitter: Emitter, particle: Particle): void {
        ...
        var data: TweenToPositionData = new TweenToPositionData(particle.x, particle.y, pt.x, pt.y);
    ...
    public update(emitter: Emitter, particle: Particle, _time: number): void {
        ...
        var data: TweenToPositionData = particle.data.get(this);
